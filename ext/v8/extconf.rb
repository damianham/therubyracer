...
$CPPFLAGS += " -rdynamic" unless $CPPFLAGS.split.include? "-rdynamic" or RUBY_PLATFORM =~ /darwin/
$CPPFLAGS += " -dynamic" unless $CPPFLAGS.split.include? "-dynamic" if RUBY_PLATFORM =~ /darwin/
